...
public class ChatController {
    ...
    public ResponseEntity<ChatResponse> chat(@RequestBody ChatRequest request) {
        ...
        log.info("POST /api/chat — userId={}, message length: {}",
                userId, request.getMessage() != null ? request.getMessage().length() : 0);
    ...
    public ResponseEntity<?> getConversation(@PathVariable Long id) {
        Long userId = securityContextUtil.getCurrentUserId();
        log.info("GET /api/chat/conversations/{} — userId={}", id, userId);
    ...
    public ResponseEntity<Void> deleteConversation(@PathVariable Long id) {
        Long userId = securityContextUtil.getCurrentUserId();
        log.info("DELETE /api/chat/conversations/{} — userId={}", id, userId);
