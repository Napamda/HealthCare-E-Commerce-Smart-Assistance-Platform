...
onMounted(() => {
  // Patient id is derived server-side from the authenticated session — no
  // argument is needed so we don't accidentally pull the wrong user's list.
  prescriptionStore.fetchMyPrescriptions()
  if (patientUserId.value != null) {
  ...
  <div class="prescription-list">
    ...
    <div v-else-if="prescriptionStore.error" class="error-state">
      ...
      <button
        ...
        @click="prescriptionStore.fetchMyPrescriptions()"
      >
        Retry
      </button>
    </div>
